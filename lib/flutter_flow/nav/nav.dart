...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ProductListPageWidget.routeName,
          path: ProductListPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ProductListPage')
              : ProductListPageWidget(),
        ),
        FFRoute(
          name: CategoryProductListPageWidget.routeName,
          path: CategoryProductListPageWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => ProductDetailPageWidget(
            ...
            selectedProduct: params.getParam(
              'selectedProduct',
              ParamType.DataStruct,
              isList: false,
        ...
        FFRoute(
          name: LoginMainScreenWidget.routeName,
          path: LoginMainScreenWidget.routePath,
          builder: (context, params) => LoginMainScreenWidget(),
        ),
        FFRoute(
          name: LoginPasswordPageWidget.routeName,
          path: LoginPasswordPageWidget.routePath,
        ...
        FFRoute(
          name: OrderListPageWidget.routeName,
          path: OrderListPageWidget.routePath,
          builder: (context, params) => params.isEmpty
        ...
        FFRoute(
          name: AddressEditPageWidget.routeName,
          path: AddressEditPageWidget.routePath,
          builder: (context, params) => AddressEditPageWidget(),
        ),
        FFRoute(
          name: AddressListPageWidget.routeName,
          path: AddressListPageWidget.routePath,
          builder: (context, params) => AddressListPageWidget(),
        ),
        FFRoute(
          name: ShippingAddressPageWidget.routeName,
          path: ShippingAddressPageWidget.routePath,
        ...
        FFRoute(
          name: SearchProductsPageWidget.routeName,
          path: SearchProductsPageWidget.routePath,
          builder: (context, params) => SearchProductsPageWidget(),
        )
