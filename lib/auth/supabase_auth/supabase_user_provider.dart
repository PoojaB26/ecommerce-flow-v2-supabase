...
class EcommerceAppSupabaseSupabaseUser extends BaseAuthUser {
  EcommerceAppSupabaseSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> ecommerceAppSupabaseSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = EcommerceAppSupabaseSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
